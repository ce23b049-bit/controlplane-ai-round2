...
Passes output directly to user  
MD

EDIT	PII / Sensitive entity detected	
Masks entity inline (e.g., [REDACTED_SSN]) before rendering  
MD

FLAG	Ambiguous risk score	
Escalates event to audit log for human review without breaking stream  
MD

BLOCK	High-confidence policy violation	
Drops connection immediately with a safety error response  
MD
